// Generated from C:/Users/Mohammad Reza/Desktop/New folder (17)/p2/src/main/grammar/FunctionCraft.g4 by ANTLR 4.13.1
package parsers;
...
public class FunctionCraftParser extends Parser {
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			((FunctionDeclarationContext)_localctx).id = match(IDENTIFIER);
			    ...
			    Identifier funcName = new Identifier((((FunctionDeclarationContext)_localctx).id!=null?((FunctionDeclarationContext)_localctx).id.getText():null));
			    funcName.setLine((((FunctionDeclarationContext)_localctx).id!=null?((FunctionDeclarationContext)_localctx).id.getLine():0));
			    _localctx.functionDeclarationRet.setFunctionName(funcName);
	...
	public final PatternMatchingContext patternMatching() throws RecognitionException {
		...
		try {
			...
			((PatternMatchingContext)_localctx).targetVar = match(IDENTIFIER);
			    ...
			    Identifier pattName = new Identifier((((PatternMatchingContext)_localctx).patternName!=null?((PatternMatchingContext)_localctx).patternName.getText():null));
			    pattName.setLine((((PatternMatchingContext)_localctx).patternName!=null?((PatternMatchingContext)_localctx).patternName.getLine():0));
			    Identifier targetName = new Identifier((((PatternMatchingContext)_localctx).targetVar!=null?((PatternMatchingContext)_localctx).targetVar.getText():null));
			    targetName.setLine((((PatternMatchingContext)_localctx).targetVar!=null?((PatternMatchingContext)_localctx).targetVar.getLine():0));
			    ((PatternMatchingContext)_localctx).patternRet =  new PatternDeclaration(pattName, targetName);
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			_localctx.forStRet.setRangeExpressions(((ForStatementContext)_localctx).r.rangeRet);
			setState(317);
			((ForStatementContext)_localctx).l = loopBody();

			    Identifier forName = new Identifier((((ForStatementContext)_localctx).id!=null?((ForStatementContext)_localctx).id.getText():null));
			    forName.setLine((((ForStatementContext)_localctx).id!=null?((ForStatementContext)_localctx).id.getLine():0));
			    ((ForStatementContext)_localctx).forStRet =  new ForStatement(forName, ((ForStatementContext)_localctx).r.rangeRet, ((ForStatementContext)_localctx).l.loopExps, ((ForStatementContext)_localctx).l.loopStmts, ((ForStatementContext)_localctx).l.loopRetStmt);
	...
	public final MatchPatternStatementContext matchPatternStatement() throws RecognitionException {
		...
		try {
			...
			((MatchPatternStatementContext)_localctx).e = expression(0);
			    ...
			    Identifier matchName = new Identifier((((MatchPatternStatementContext)_localctx).id!=null?((MatchPatternStatementContext)_localctx).id.getText():null));
			    matchName.setLine((((MatchPatternStatementContext)_localctx).id!=null?((MatchPatternStatementContext)_localctx).id.getLine():0));
			    ((MatchPatternStatementContext)_localctx).matchPatRet =  new MatchPatternStatement(matchName, ((MatchPatternStatementContext)_localctx).e.expRet);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					if(((ExpressionContext)_localctx).e1.expRet instanceof Identifier) {
					              ...
					              AppendExpression a = (AppendExpression)_localctx.expRet;
					              a.addAppendedExpression(((ExpressionContext)_localctx).e2.expRet);
					              ((ExpressionContext)_localctx).e1.expRet = a;
					}
					} 
				}
				setState(449);
